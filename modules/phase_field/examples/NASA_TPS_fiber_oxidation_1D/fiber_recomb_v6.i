...
[Materials]
  ...
  [./mobility_O]
    # Mobility of oxygen in the bulk and in the gas phase
    type = DerivativeParsedMaterial
    f_name = M_O
    material_property_names = h(eta)
    constant_names = 'M_g M_f'
    constant_expressions = '1 0.01'
  ...
  [./mobility_CO]
    # Mobility of CO in the bulk and in the gas phase
    type = DerivativeParsedMaterial
    f_name = M_CO
    material_property_names = h(eta)
    constant_names = 'M_g M_f'
  ...
  [./mobility_C]
    ...
    material_property_names = h(eta)
    constant_names = 'M_g M_f'
    constant_expressions = '0.001 0.01'
    function = 'h * M_g+ (1 - h) * M_f'
    outputs = exodus
